...
static SITE_RESOURCE_NAME_PATTERN: LazyLock<Pattern> = LazyLock::new(|| {
    Pattern::parse(SiteResourceName::PATTERN).expect("a generated pattern parses")
});
...
impl SiteResourceName {
    ...
    pub fn new(shipper: impl Into<String>, site: impl Into<String>) -> Result<Self, Error> {
