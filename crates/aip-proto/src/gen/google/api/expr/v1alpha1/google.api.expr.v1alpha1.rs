...
#[prost_reflect(message_name = "google.api.expr.v1alpha1.ParsedExpr")]
...
#[derive(::prost_reflect::ReflectMessage)]
#[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
#[prost_reflect(message_name = "google.api.expr.v1alpha1.Expr")]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Expr {
    #[prost(int64, tag="2")]
    pub id: i64,
...
pub mod expr {
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Expr.Ident")]
    ...
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Expr.Select")]
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Select {
    ...
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Expr.Call")]
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Call {
        #[prost(message, optional, boxed, tag="1")]
    ...
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Expr.CreateList")]
    #[derive(Clone, PartialEq, ::prost::Message)]
    ...
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Expr.CreateStruct")]
    #[derive(Clone, PartialEq, ::prost::Message)]
    ...
    pub mod create_struct {
        #[derive(::prost_reflect::ReflectMessage)]
        #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
        #[prost_reflect(message_name = "google.api.expr.v1alpha1.Expr.CreateStruct.Entry")]
        #[derive(Clone, PartialEq, ::prost::Message)]
        pub struct Entry {
            #[prost(int64, tag="1")]
            pub id: i64,
    ...
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Expr.Comprehension")]
    #[derive(Clone, PartialEq, ::prost::Message)]
...
#[derive(::prost_reflect::ReflectMessage)]
#[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
#[prost_reflect(message_name = "google.api.expr.v1alpha1.Constant")]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Constant {
...
#[derive(::prost_reflect::ReflectMessage)]
#[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
#[prost_reflect(message_name = "google.api.expr.v1alpha1.SourceInfo")]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod source_info {
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.SourceInfo.Extension")]
    #[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
    ...
    pub mod extension {
        #[derive(::prost_reflect::ReflectMessage)]
        #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
        #[prost_reflect(message_name = "google.api.expr.v1alpha1.SourceInfo.Extension.Version")]
...
#[derive(::prost_reflect::ReflectMessage)]
#[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
#[prost_reflect(message_name = "google.api.expr.v1alpha1.SourcePosition")]
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
...
#[derive(::prost_reflect::ReflectMessage)]
#[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
#[prost_reflect(message_name = "google.api.expr.v1alpha1.CheckedExpr")]
#[derive(Clone, PartialEq, ::prost::Message)]
...
#[derive(::prost_reflect::ReflectMessage)]
#[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
#[prost_reflect(message_name = "google.api.expr.v1alpha1.Type")]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Type {
...
pub mod r#type {
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Type.ListType")]
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct ListType {
        #[prost(message, optional, boxed, tag="1")]
    ...
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Type.MapType")]
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct MapType {
        #[prost(message, optional, boxed, tag="1")]
    ...
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Type.FunctionType")]
    #[derive(Clone, PartialEq, ::prost::Message)]
    ...
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Type.AbstractType")]
    #[derive(Clone, PartialEq, ::prost::Message)]
...
#[derive(::prost_reflect::ReflectMessage)]
#[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
#[prost_reflect(message_name = "google.api.expr.v1alpha1.Decl")]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Decl {
    #[prost(string, tag="1")]
    pub name: ::prost::alloc::string::String,
...
pub mod decl {
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Decl.IdentDecl")]
    #[derive(Clone, PartialEq, ::prost::Message)]
    ...
    #[derive(::prost_reflect::ReflectMessage)]
    #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
    #[prost_reflect(message_name = "google.api.expr.v1alpha1.Decl.FunctionDecl")]
    #[derive(Clone, PartialEq, ::prost::Message)]
    ...
    pub mod function_decl {
        #[derive(::prost_reflect::ReflectMessage)]
        #[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
        #[prost_reflect(message_name = "google.api.expr.v1alpha1.Decl.FunctionDecl.Overload")]
        #[derive(Clone, PartialEq, ::prost::Message)]
        pub struct Overload {
            #[prost(string, tag="1")]
...
#[derive(::prost_reflect::ReflectMessage)]
#[prost_reflect(descriptor_pool = "crate::DESCRIPTOR_POOL")]
#[prost_reflect(message_name = "google.api.expr.v1alpha1.Reference")]
#[derive(Clone, PartialEq, ::prost::Message)]
