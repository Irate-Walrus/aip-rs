...
impl ::prost_reflect::ReflectMessage for Site {
    fn descriptor(&self) -> ::prost_reflect::MessageDescriptor {
        crate::proto::DESCRIPTOR_POOL
            .get_message_by_name("einride.example.freight.v1.Site")
            .expect("descriptor pool contains einride.example.freight.v1.Site")
    }
}
