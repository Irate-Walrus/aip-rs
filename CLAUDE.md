...
Always use the /caveman skill including in inline code documentation. No inline
code comment should be more than two sentences. User-facing code or comments
should never contain references to ADRs, AIPs, PRs, or Issues.